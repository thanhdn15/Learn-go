...
const (
	GatewayService_Echo_FullMethodName = "/getwaypd.GatewayService/Echo"
)
...
func (c *gatewayServiceClient) Echo(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, GatewayService_Echo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var GatewayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "getwaypd.GatewayService",
